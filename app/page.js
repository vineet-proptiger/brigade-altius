    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        <a
          ...
          className="flex-1 flex flex-col items-center justify-center gap-0.5 !py-2 !px-0 transition-colors duration-200 bg-[#111827] text-white active:!bg-white active:!text-[#111827]"
        >
        ...
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex flex-col items-center justify-center gap-0.5 btn-gold !py-2 !px-0 !rounded-none transition-colors duration-200 active:!bg-none active:!bg-white active:!text-[#111827]"
        >
        ...
        <a
          href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Brigade%20Altius"
          target="_blank" rel="noopener noreferrer"
          className="flex-1 flex flex-col items-center justify-center gap-0.5 py-2 !px-0 transition-colors duration-200 bg-[#25D366] text-white active:!bg-white active:!text-[#25D366]"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

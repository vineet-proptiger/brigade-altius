...
const locations = [
  { name: 'Chennai International Airport', dist: '25 mins' },
  { name: 'OMR Road', dist: '2 mins' },
  { name: 'IIT Madras', dist: '10 km' },
  { name: 'Anna University', dist: '15 km' },
  { name: 'Kauvery Hospital', dist: '20 km' },
  { name: 'Apollo Speciality Hospital', dist: '15 km' },
  { name: 'TIDEL Park', dist: '15 mins' },
  { name: 'Phoenix Market City', dist: '10 km' },
  { name: 'The Leela Palace Chennai', dist: '15 km' },
  { name: 'ITC Grand Chola', dist: '20 km' },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              ...
              <div>
                {locations.map((item, i) => (
                  <div key={i} style={{
                    ...
                    borderBottom: i === locations.length - 1 ? 'none' : '1px solid #D5C2A8',
                  }}>
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3205.4562393586566!2d80.22461787507523!3d12.902297687406742!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d0077df0c2f%3A0x5d62fc164010b996!2sBrigade%20Altius!5e1!3m2!1sen!2sin!4v1782369985417!5m2!1sen!2sin"
                width="100%"
                height="100%"

...
const infoItems = [
  { label: 'LAND PARCEL',   value: '6.61 Acres' },
  { label: 'TOTAL UNITS',   value: '661 Apartments' },
  { label: 'TOWERS',        value: '3 Towers' },
  { label: 'FLOORS',        value: '40+ Floors' },
]
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-14">
        ...
        <div className="w-full lg:w-1/2" data-aos="fade-right">
          ...
          <p style={{
            ...
            Brigade Altius, Chennai is a premium residential project by the renowned Brigade Group, located in a prominent area along OMR Road, one of Chennai's key IT and business corridors. This upcoming development is set within a thoughtfully planned community featuring elegant high-rise towers.
          </p>
          <p style={{
            fontFamily: F_SANS, fontSize: '14.5px', color: '#4A4540',
            lineHeight: 1.9,
            ...
            The project offers spacious 3 and 4 BHK apartments, crafted to deliver a luxurious and contemporary living experience. Each home is designed with modern layouts and high-quality finishes, making it an ideal choice for families who value both comfort and sophistication.
          </p>

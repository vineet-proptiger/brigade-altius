    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        <h2 style={{
          ...
          color: '#684C1B', letterSpacing: '0.05em',
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                Brigade is a leading property developer in South India, with projects spanning several major cities including Bangalore, Chennai, Chikmagalur, Hyderabad, Kochi, Mangalore, and Mysore. Our portfolio includes a wide range of apartments and villas. Discover luxurious apartments in Bangalore, Chennai, and Hyderabad. Headquartered in Bangalore, Brigade Group has branch offices across South India and a representative office in Dubai. We have made a significant mark in the commercial sector by developing some of Bangalore's largest malls. Brigade Group boasts a uniquely diverse multi-domain portfolio encompassing property development, property management services, hospitality, and education.
              </p>
            </div>

    ...
    <section className="hero-container">
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          <span style={{ fontSize: '0.85em', fontWeight: 500, textTransform: 'none' }}>Sholinganallur, Chennai</span>
        </p>
        {/* Bullet Points */}
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            'Payment Plan: 50:50',
            'Avail Pre-Launch Benefits up to 7L',
            'Early Buy Discounts for only first 100 clients',
            'Floors : 40+ | 3 Towers',
            '2B + S+ 3 level Multilevel Parking',
            'Land Extent: 6.61 Acres | 661 Apartments'
          ].map((text, i) => (
        ...
        <div className="hero-cta-row" style={{ marginTop: '16px' }}>
          ...
          >
            Starting Price : <span className="hero-price-amt" style={{ fontSize: '15px', marginLeft: '6px' }}>₹ 2.18 Cr*</span>
          </div>

    ...
    <nav style={{
      ...
      <div style={{
        ...
        <a href="#" style={{ flexShrink: 0, display: 'flex', alignItems: 'center' }}>
          <style>{`
            .nav-logo { height: 50px; width: auto; display: block; object-fit: contain; transform: scale(1.2, 1.1); transform-origin: center; }
            @media(max-width: 768px) {
              .nav-logo { height: 42px; transform: scale(1.1, 1.05); }
            }
          `}</style>
          <img
            src={logoImages.tarc}
